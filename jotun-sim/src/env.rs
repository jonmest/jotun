//! Sim-supplied [`jotun_core::Env`] that sources nondeterminism from
//! the cluster RNG.
//!
...
/// A [`jotun_core::Env`] that draws election timeouts from the cluster's
...
impl jotun_core::Env for SimEnv {
